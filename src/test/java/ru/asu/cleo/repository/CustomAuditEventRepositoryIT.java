...
import ru.asu.cleo.config.audit.AuditEventConverter;
import ru.asu.cleo.domain.PersistentAuditEvent;
...
import static ru.asu.cleo.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
