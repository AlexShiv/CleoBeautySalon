...
public class EmployeeResourceIT {
    ...
    private static final String DEFAULT_PATRONOMIC = "AAAAAAAAAA";
    private static final String UPDATED_PATRONOMIC = "BBBBBBBBBB";
    ...
    public void createEmployee() throws Exception {
        ...
        assertThat(testEmployee.getPatronomic()).isEqualTo(DEFAULT_PATRONOMIC);
    ...
    public void getAllEmployees() throws Exception {
        ...
        restEmployeeMockMvc.perform(get("/api/employees?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].patronomic").value(hasItem(DEFAULT_PATRONOMIC)))
    ...
    public void getEmployee() throws Exception {
        ...
        restEmployeeMockMvc.perform(get("/api/employees/{id}", employee.getId()))
            ...
            .andExpect(jsonPath("$.patronomic").value(DEFAULT_PATRONOMIC))
    ...
    public void updateEmployee() throws Exception {
        ...
        assertThat(testEmployee.getPatronomic()).isEqualTo(UPDATED_PATRONOMIC);
